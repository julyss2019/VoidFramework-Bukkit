...
/**
 * 主要为了解决 Relocation 重定向规则被 ShadowJar 误 relocate 的问题
 ...
 */
public class ShadowSafeRelocation extends Relocation {
    private ShadowSafeRelocation(@NonNull String from, @NonNull String to) {
        super(from, to);
    }
