...
public class CommandManager {
    ...
    public CommandManager(@NonNull VoidFrameworkPlugin plugin) {
        this.voidFrameworkPlugin = plugin;
    ...
    public CommandFramework createCommandFramework(@NonNull Plugin plugin) {
        CommandFramework commandFramework = new CommandFramework(voidFrameworkPlugin, plugin);
