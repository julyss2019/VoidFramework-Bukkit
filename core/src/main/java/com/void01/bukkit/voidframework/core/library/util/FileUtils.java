package com.void01.bukkit.voidframework.core.library.util;
...
public class FileUtils {
    @SneakyThrows
    public static void downloadFromUrlIf200Response(@NonNull String urlStr, @NonNull File dest, boolean overwrite) {
        ...
        if (responseCode != 200) {
            throw new RuntimeException("Download failed, response code is: " + responseCode);
        }
